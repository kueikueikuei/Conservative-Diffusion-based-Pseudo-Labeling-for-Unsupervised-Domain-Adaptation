...
class CNN(nn.Module):
    ...
    def __init__(self, num_classes=10, isL2 = True):
    ...
    def forward(self, x, debug=False):
        ...
        return self.fc1(x), x
class Cifar10_13layer(nn.Module):
    """
    CNN from Mean Teacher paper
    """
    
    def __init__(self, num_classes=10, isL2 = True):
        super(cifar10_13layer, self).__init__()
        self.backbone=CNN()
        self.classifier1= weight_norm(nn.Linear(128, num_classes))
    def forward(self, x):
